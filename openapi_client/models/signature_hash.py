...
class SignatureHash(object):
    ...
    allowable_values = [SHA1, SHA256, SHA512, SHA224, SHA384]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """SignatureHash - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SignatureHash):
            return False
