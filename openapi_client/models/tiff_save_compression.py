...
class TiffSaveCompression(object):
    ...
    allowable_values = [DEFLATE, CCITT3, CCITT4, LZW, JPEG, RLE, AUTO]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TiffSaveCompression - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TiffSaveCompression):
            return False
