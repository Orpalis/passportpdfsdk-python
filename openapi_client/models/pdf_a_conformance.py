...
class PdfAConformance(object):
    ...
    allowable_values = [PDFA1A, PDFA1B, PDFA2A, PDFA2B, PDFA2U, PDFA3A, PDFA3B, PDFA3U]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PdfAConformance - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PdfAConformance):
            return False
