...
class StandardFontName(object):
    ...
    allowable_values = [COURIER, HELVETICA, TIMES, SYMBOL, ZAPFDINGBATS]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StandardFontName - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StandardFontName):
            return False
