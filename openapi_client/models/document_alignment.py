...
class DocumentAlignment(object):
    ...
    allowable_values = [MIDDLELEFT, MIDDLERIGHT, MIDDLECENTER, TOPLEFT, TOPRIGHT, TOPCENTER, BOTTOMLEFT, BOTTOMRIGHT, BOTTOMCENTER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """DocumentAlignment - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentAlignment):
            return False
