...
class DocumentFormat(object):
    ...
    allowable_values = [UNKNOWN, ICO, BMP, WBMP, JPEG, GIF, PNG, TIFF, FAXG3, EXIF, EMF, WMF, JNG, KOALA, IFF, MNG, PCD, PCX, PBM, PBMRAW, PFM, PGM, PGMRAW, PPM, PPMRAW, RAS, TARGA, PSD, CUT, XBM, XPM, DDS, HDR, SGI, EXR, J2K, JP2, PICT, RAW, WEBP, DICOM, JBIG, JBIG2, WSQ, PDF, SVG, TXT, DOCX, RTF, DXF, ODT, XLSX, PPTX]  # noqa: E501
